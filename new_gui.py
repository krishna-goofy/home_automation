...
class App(customtkinter.CTk):
    ...
    def __init__(self,*args, **kw):
        ...
        IMAGE_WIDTH = 140
        IMAGE_HEIGHT = 140
        IMAGE_PATH = r'test_images\Goofy_Chacha_Avatar-fotor-20230803171133.png'
        ...
        img=customtkinter.CTkImage(Image.open(r"test_images\mic.png"))
        ...
        self.radio_button_3 = customtkinter.CTkRadioButton(master=self.frame_right,
                                                           ...
                                                           font=("Roboto Medium", 13),
                                                           command=lambda:self.send_value('15'.encode()),
                                                           value=0)
        self.radio_button_3.grid(row=2, column=0, pady=10, padx=20, sticky="n")

        self.radio_button_4 = customtkinter.CTkRadioButton(master=self.frame_right,
                                                           text="2.Light Off",
                                                           variable=self.radio_var2,
                                                           font=("Roboto Medium", 13),
                                                           command=lambda:self.send_value('13'.encode()),
                                                           value=1)
        self.radio_button_4.grid(row=2, column=1, pady=10, padx=20, sticky="w")

        self.radio_button_5 = customtkinter.CTkRadioButton(master=self.frame_right,
                                                           text="3.Light On",
                                                           variable=self.radio_var3,
                                                           font=("Roboto Medium", 13),
                                                           command=lambda:self.send_value('19'.encode()),
                                                           value=0)
        self.radio_button_5.grid(row=3, column=0, pady=10, padx=20, sticky="n")

        self.radio_button_6 = customtkinter.CTkRadioButton(master=self.frame_right,
                                                           text="3.Light Off",
                                                           variable=self.radio_var3,
                                                           font=("Roboto Medium", 13),
                                                           command=lambda:self.send_value('17'.encode()),
                                                           value=1)
        self.radio_button_6.grid(row=3, column=1, pady=10, padx=20, sticky="w")

        self.radio_button_7 = customtkinter.CTkRadioButton(master=self.frame_right,
                                                           text="4.Light On",
                                                           variable=self.radio_var4,
                                                           font=("Roboto Medium", 13),
                                                           command=lambda:self.send_value('23'.encode()),
                                                           value=0)
        self.radio_button_7.grid(row=4, column=0, pady=10, padx=20, sticky="n")

        self.radio_button_8 = customtkinter.CTkRadioButton(master=self.frame_right,
                                                           text="4.Light Off",
                                                           variable=self.radio_var4,
                                                           font=("Roboto Medium", 13),
                                                           command=lambda:self.send_value('21'.encode()),
                                                           value=1)
        self.radio_button_8.grid(row=4, column=1, pady=10, padx=20, sticky="w")

        self.radio_button_9 = customtkinter.CTkRadioButton(master=self.frame_right,
                                                           text="5.Light On",
                                                           variable=self.radio_var5,
                                                           font=("Roboto Medium", 13),
                                                           command=lambda:self.send_value('27'.encode()),
                                                           value=0)
        self.radio_button_9.grid(row=5, column=0, pady=10, padx=20, sticky="n")

        self.radio_button_10 = customtkinter.CTkRadioButton(master=self.frame_right,
                                                           text="5.Light Off",
                                                           variable=self.radio_var5,
                                                           font=("Roboto Medium", 13),
                                                           command=lambda:self.send_value('25'.encode()),
                                                           value=1)
        self.radio_button_10.grid(row=5, column=1, pady=10, padx=20, sticky="w")

        self.radio_button_11 = customtkinter.CTkRadioButton(master=self.frame_right,
                                                           text="6.Light On",
                                                           variable=self.radio_var6,
                                                           font=("Roboto Medium", 13),
                                                           command=lambda:self.send_value('31'.encode()),
                                                           value=0)
        self.radio_button_11.grid(row=6, column=0, pady=10, padx=20, sticky="n")

        self.radio_button_12 = customtkinter.CTkRadioButton(master=self.frame_right,
                                                           text="6.Light Off",
                                                           variable=self.radio_var6,
                                                           font=("Roboto Medium", 13),
                                                           command=lambda:self.send_value('29'.encode()),
                                                           value=1)
        self.radio_button_12.grid(row=6, column=1, pady=10, padx=20, sticky="w")

        self.radio_button_13 = customtkinter.CTkRadioButton(master=self.frame_right,
                                                           text="7.Light On",
                                                           variable=self.radio_var7,
                                                           font=("Roboto Medium", 13),
                                                           command=lambda:self.send_value('43'.encode()),
                                                           value=0)
        self.radio_button_13.grid(row=7, column=0, pady=10, padx=20, sticky="n")

        self.radio_button_14 = customtkinter.CTkRadioButton(master=self.frame_right,
                                                           text="7.Light Off",
                                                           variable=self.radio_var7,
                                                           font=("Roboto Medium", 13),
                                                           command=lambda:self.send_value('41'.encode()),
                                                           value=1)
        self.radio_button_14.grid(row=7, column=1, pady=10, padx=20, sticky="w")

        self.radio_button_15 = customtkinter.CTkRadioButton(master=self.frame_right,
                                                           text="8.Light On",
                                                           variable=self.radio_var8,
                                                           font=("Roboto Medium", 13),
                                                           command=lambda:self.send_value('47'.encode()),
                                                           value=0)
        self.radio_button_15.grid(row=8, column=0, pady=10, padx=20, sticky="n")

        self.radio_button_16 = customtkinter.CTkRadioButton(master=self.frame_right,
                                                           text="8.Light Off",
                                                           variable=self.radio_var8,
                                                           font=("Roboto Medium", 13),
                                                           command=lambda:self.send_value('45'.encode()),
                                                           value=1)
        self.radio_button_16.grid(row=8, column=1, pady=10, padx=20, sticky="w")

        self.radio_button_17 = customtkinter.CTkRadioButton(master=self.frame_right,
                                                           text="9.Light On",
                                                           variable=self.radio_var9,
                                                           font=("Roboto Medium", 13),
                                                           command=lambda:self.send_value('51'.encode()),
                                                           value=0)
        self.radio_button_17.grid(row=9, column=0, pady=10, padx=20, sticky="n")

        self.radio_button_18 = customtkinter.CTkRadioButton(master=self.frame_right,
                                                           text="9.Light Off",
                                                           variable=self.radio_var9,
                                                           font=("Roboto Medium", 13),
                                                           command=lambda:self.send_value('49'.encode()),
                                                           value=1)
        self.radio_button_18.grid(row=9, column=1, pady=10, padx=20, sticky="w")

        self.radio_button_19 = customtkinter.CTkRadioButton(master=self.frame_right,
                                                           text="10.Light On",
                                                           variable=self.radio_var10,
                                                           font=("Roboto Medium", 13),
                                                           command=lambda:self.send_value('55'.encode()),
                                                           value=0)
        self.radio_button_19.grid(row=10, column=0, pady=10, padx=20, sticky="n")

        self.radio_button_20 = customtkinter.CTkRadioButton(master=self.frame_right,
                                                           text="10.Light Off",
                                                           variable=self.radio_var10,
                                                           font=("Roboto Medium", 13),
                                                           command=lambda:self.send_value('53'.encode()),
                                                           value=1)
        self.radio_button_20.grid(row=10, column=1, pady=10, padx=20, sticky="w")
